...
ALTER TABLE commentaires ADD COLUMN utilisateur_id VARCHAR(36) NOT NULL;
ALTER TABLE services ADD COLUMN utilisateur_id VARCHAR(36) NOT NULL;
ALTER TABLE custom_sessions ADD COLUMN utilisateur_id VARCHAR(36) NOT NULL;
ALTER TABLE horaires ADD COLUMN utilisateur_id VARCHAR(36) NOT NULL;
ALTER TABLE messages ADD COLUMN utilisateur_id VARCHAR(36) NOT NULL;
